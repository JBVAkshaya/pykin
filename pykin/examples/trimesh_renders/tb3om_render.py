...
urdf_path = "urdf/tb3arm/turtlebot3_manipulation.urdf"
robot = SingleArm(urdf_path, Transform(rot=[0.0, 0.0, 0.0], pos=[0.1, 0., 0.3]))
robot.setup_link_name("base_footprint", "link5")
...
goal_qpos = np.array([0.0,0.785,0,1.57]) # Takes the 4 revolute joint values as an input
